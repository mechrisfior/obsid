...
config:
  ...
  source_data: tag
  source_form_result: books
  source_destination_path: /5. Creations/BeWorkings
  row_templates_folder: Chris-idian/Templates
  current_row_template: 
  pagination_size: 10
  font_size: 10
  enable_js_formulas: true
  formula_folder_path: Chris-idian/Templates
  inline_default: true
